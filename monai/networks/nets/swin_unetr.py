...
class SwinSACAUNETR(nn.Module):
    ...
    def forward(self, x_in, x_flip):
        hidden_states_out = self.swinViT(x_in, self.normalize)
        x_out = hidden_states_out[4]
        ...
        x_reshape = self.symmetryAwareTX(x_reshape, encoder_hidden_states=x_flip_reshape)[0]
        x_rec = x_reshape.transpose(1, 2)
