...
parser.add_argument("--use_pretrain", action="store_true", help="use pretrained weights to initialize")
parser.add_argument("--use_checkpoint", action="store_true", help="use gradient checkpointing to save memory")
parser.add_argument("--spatial_dims", default=3, type=int, help="spatial dimension of input data")
parser.add_argument("--gpu_node", default=0, type=int, help="the node index of gpu for training")
parser.add_argument("--wandb_project", default='BraTS', type=str, help="the project name for wandb")
parser.add_argument("--semantic_classes", default='Dice_Val_TC,Dice_Val_WT,Dice_Val_ET', type=str, help="semantic "
                                                                                                        "class label")
...
parser.add_argument("--output_dir", default="./datasets/msseg/validation/val.json", type=str, help="val out dir")
...
def main():
    ...
    print('the current rank is: ', args.rank)
    if args.distributed:
        ...
        main_worker(gpu=args.gpu_node, args=args)
...
def main_worker(gpu, args):
    ...
    model.cuda(args.gpu)
    semantic_classes = args.semantic_classes.split(',')
