...
parser.add_argument("--wandb_project", default="CT-Pretrain", help="number of workers")
...
def main():
    ...
    loss_function = Loss_Asymmetry(args.batch_size, args)
    if args.distributed:
